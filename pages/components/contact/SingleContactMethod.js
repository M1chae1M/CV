...
export default class SingleContactMethod extends Component{
    render(){
        ...
        return(
            <a style={styles.a} href={href} name={name} target="_blank" rel="noreferrer" download={download} draggable={false}>
